...
ident_var <- function (data,variables) {
  ...
  if(!(station_label %in% names(merged))){
    for (label in c("Station", "station", "Station_id", "station_id", "ID", "ID.",
                    "Name", "name", "StationName", "StationID",
                    "era_name", "tower_name")){
  ...
  if(!(reana_label %in% names(merged))){
    for (label in c("ReanaName")){
      if (label %in% names(data)){
        merged[[station_label]]<-label
        break
      }
  ...
  if(!(lat_label %in% names(merged))) {
    for (label in c("lat", "Lat", "Latitude", "latitude")){
      if (label %in% names(data)){
  ...
  if(!(lon_label %in% names(merged))) {
    for (label in c("lon", "Lon", "Longitude", "longitude")){
      if (label %in% names(data)){
  ...
  if(!(height_label %in% names(merged))) {
    for (label in c("height", "Height")){
      if (label %in% names(data)){
        merged[[alt_label]]<-label
        break
      }
